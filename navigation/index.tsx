...
const HomeHeader = (props) => {
  ...
  return (
    <View style={{ flexDirection: 'row', justifyContent: 'space-between', width, padding: 10, alignItems: 'center' }}>
      ...
      <Text style={{ flex: 1, textAlign: 'center', marginLeft: 40, fontWeight: 'bold', fontSize: 16}}>Home</Text>
...
const ChatRoomHeader = (props) => {
  ...
  return (
    <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: width - 55, padding: 5, alignItems: 'center' }}>
      <Image source={{ uri: 'https://notjustdev-dummy.s3.us-east-2.amazonaws.com/avatars/vadim.jpg' }} style={{ width: 30, height: 30, borderRadius: 30, }} />
      <Text style={{ flex: 1, marginLeft: 10, fontWeight: 'bold', fontSize: 16}}>{props.children}</Text>
      <Feather name="camera" size={24} color="black" style={{ marginHorizontal: 10 }} />
      <Feather name="edit-2" size={24} color="black" style={{ marginHorizontal: 10 }} />
    </View>
  )
